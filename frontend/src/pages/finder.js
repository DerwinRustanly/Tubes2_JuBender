...
const miserables = {
  nodes: [{id: "Adadadad", group: 1},
          {id: "Bdada", group: 1},
          {id: "Cdfagabgdnghngahndgnagdngandghngandgngndghngh", group: 1},
          {id: "Ddadadadadadfafdf", group: 1},
          {id: "Edadafefadfada", group: 1},
],
  links: [{source: "Adadadad", target: "Bdada", value: 1},
  {source: "Bdada", target: "Cdfagabgdnghngahndgnagdngandghngandgngndghngh", value: 1},
  {source: "Cdfagabgdnghngahndgnagdngandghngandgngndghngh", target: "Ddadadadadadfafdf", value: 1},
  ...
  return (
    <div className="w-full min-h-screen flex flex-col  text-white items-center">
      <div className="w-[577px] font-inter my-60">
        ...
        <div ref={graphContainerRef} className="w-full h-96 rounded-xl bg-white mt-4">
