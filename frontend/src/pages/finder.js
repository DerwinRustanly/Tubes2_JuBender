...
const miserables = {
  nodes: [
    { id: "Adadadad", group: 1 },
    { id: "Bdada", group: 1 },
    { id: "Cdfagabgdnghngahndgnagdngandghngandgngndghngh", group: 1 },
    { id: "Ddadadadadadfafdf", group: 1 },
    { id: "Edadafefadfada", group: 1 },
  ],
  links: [
    { source: "Adadadad", target: "Bdada", value: 1 },
    {
      source: "Bdada",
      target: "Cdfagabgdnghngahndgnagdngandghngandgngndghngh",
      value: 1,
    },
    {
      source: "Cdfagabgdnghngahndgnagdngandghngandgngndghngh",
      target: "Ddadadadadadfafdf",
      value: 1,
    },
    { source: "Ddadadadadadfafdf", target: "Edadafefadfada", value: 1 },
  ],
};
...
function LoadingPopup() {
  return (
    <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50 z-50">
      <div className="bg-4 p-5 rounded-lg flex items-center">
        <div className="loader">
          <div role="status">
            <svg
              aria-hidden="true"
              className="w-8 h-8 text-gray-200 animate-spin dark:text-4 fill-5"
              viewBox="0 0 100 101"
              fill="none"
        ...
        <p className="ml-4 text-5 font-bold">Searching...</p>
      </div>
    </div>
  );
}
    ...
    <div className="w-full min-h-screen flex flex-col  text-white items-center">
      ...
      <div className="w-[577px] font-inter my-60">
        ...
        <div
          ...
          className="w-full h-96 rounded-xl bg-white mt-4"
        ></div>
        ...
        <div className="mt-8 w-full">
          ...
          <div className="w-full pt-4 flex flex-col gap-2">
            {dummyPaths.map((item) => (
              <div
                key={item.id}
                className="w-full flex flex-row items-center mb-2 gap-4"
              >
